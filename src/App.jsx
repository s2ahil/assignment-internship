...
function App() {
  ...
  return (
    <div className="bg-gradient-to-b from-yellow-50 via-white to-yellow-100 h-full">
      ...
      <div className='flex flex-col justify-center items-center md:flex-row md:justify-between gap-2 bg-red-500 h-[8rem] pl-4 pr-4 '>
